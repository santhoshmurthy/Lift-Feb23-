...
public class SupremecourtCard {
    String titlepara, contextpara, questionpara, answerpara, referencepara, texttouch;
    public SupremecourtCard(String titlepara,String contextpara,String questionpara,String answerpara,String referencepara,String texttouch) {
